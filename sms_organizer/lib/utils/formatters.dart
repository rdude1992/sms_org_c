...
class Formatters {
  ...
  /// Month and short-year split apart — TrendBarChart/TrendLineChart's
  /// month-granularity x-axis ticks stack these on two lines ("Aug"/"25")
  /// rather than "Aug 25" on one, so a wide date range ("All time") that
  /// packs ticks close together doesn't run one label into its neighbour.
